...
export const MEALS: Meal[] = [
  ...
  },
  {
    ...
    name: 'Eggplant Omelette with Ground Meat',
    category: 'breakfast',
    protein: 30,
    calories: 430,
    minutes: 20,
  ...
  },
  {
    ...
    ingredients: ['2 cans tuna or 150g pork', 'Squash, eggplant, string beans, okra', 'Shrimp paste (bagoong)', 'Garlic, onion, tomato'],
  ...
  },
  {
    ...
    ingredients: ['300g shrimp', '1 sachet tamarind soup mix (sinigang)', 'Water spinach, string beans, radish, eggplant', 'Tomato and onion', 'Long green chilli'],
...
export const GROCERY_LIST: GrocerySection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'String beans, okra, eggplant, squash', qty: 'mixed, for pinakbet', price: 130 },
