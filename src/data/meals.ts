...
export const MEAL_CATEGORIES: { id: MealCategory; label: string; emoji: string }[] = [
  { id: 'breakfast', label: 'Almusal', emoji: '🌅' },
  { id: 'lunch', label: 'Tanghalian', emoji: '🍚' },
  { id: 'dinner', label: 'Hapunan', emoji: '🍲' },
  { id: 'snack', label: 'Meryenda', emoji: '🍡' },
];
...
export const MEALS: Meal[] = [
  ...
  {
    id: 'tokwat-itlog',
    name: "Tokwa't Itlog Guisado",
    category: 'breakfast',
    protein: 28,
    calories: 400,
    minutes: 15,
    cookware: 'stovetop',
    tags: ['budget', 'plant protein'],
    ingredients: ['1 block tokwa, cubed', '2 eggs', 'Garlic and onion', '2 tbsp soy sauce', 'Kalamansi'],
    method: 'Fry the tokwa until golden, set aside. Sauté garlic and onion, return tokwa, splash soy sauce. Push aside, scramble the eggs in, then combine. Kalamansi on top.',
  },
  {
    ...
    ingredients: ['150g chicken breast, sliced', '3/4 cup rice', 'Ginger, garlic, onion', '1 boiled egg', 'Fish sauce, kalamansi, spring onion'],
    method: 'Sauté ginger, garlic, onion. Add chicken and rice, then water, simmer 20 min until porridge-thick. Season with fish sauce, top with boiled egg and kalamansi.',
    prepAhead: 'Makes 2 bowls. Keeps 3 days in the fridge, loosen with hot water when reheating.',
  },
  {
    id: 'tortang-talong-giniling',
    name: 'Tortang Talong with Giniling',
    category: 'breakfast',
    protein: 30,
    calories: 430,
    minutes: 20,
    cookware: 'stovetop',
    tags: ['classic'],
    ingredients: ['1 eggplant', '3 eggs', '100g ground pork or chicken', 'Garlic, onion, tomato', 'Salt and pepper'],
    method: 'Char the eggplant directly on the stove flame, peel, flatten. Brown the giniling with garlic, onion and tomato. Dip the eggplant in beaten egg, fry, spoon the giniling over.',
  },
  {
  ...
  {
    id: 'egg-kamatis-rice',
    name: 'Scrambled Eggs, Kamatis & Rice',
    category: 'breakfast',
    protein: 22,
    calories: 390,
    minutes: 8,
  ...
  },
  {
    ...
    ingredients: ['1 cup monggo beans', '1 pack tinapa flakes or 100g pork', 'Garlic, onion, tomato', 'Malunggay or kangkong', 'Fish sauce'],
    method: 'Boil monggo 30 min until soft. Sauté garlic, onion, tomato, add tinapa, then the monggo with its water. Simmer, stir in the greens at the very end.',
  ...
  },
  {
    ...
    cookware: 'stovetop',
    tags: ['soup', 'light'],
    ingredients: ['400g chicken (thigh and breast)', 'Ginger, garlic, onion', 'Green papaya or sayote', 'Malunggay or chili leaves', 'Fish sauce'],
    method: 'Sauté ginger, garlic, onion, brown the chicken, add water and simmer 20 min. Add papaya until tender, then the leaves off the heat.',
  ...
  },
  {
    ...
    ingredients: ['300g beef sirloin, thin sliced', '3 tbsp soy sauce', 'Kalamansi juice', '2 onions, in rings', 'Pepper'],
    method: 'Marinate beef in soy, kalamansi and pepper 30 min. Sear hard and fast, remove. Soften the onions in the pan, return the beef with the marinade, simmer 5 min.',
  },
  {
    id: 'ginisang-sardinas',
    name: 'Ginisang Sardinas with Kangkong',
    category: 'lunch',
    protein: 24,
    calories: 330,
    minutes: 12,
    cookware: 'stovetop',
    tags: ['budget', 'omega 3'],
    ingredients: ['2 cans sardines in tomato sauce', '1 bundle kangkong', 'Garlic, onion', 'Siling haba', 'Pepper'],
    method: 'Sauté garlic and onion, add sardines and break them up gently. Add kangkong stems first, then leaves, cook until just wilted.',
  },
  {
  ...
  },
  {
    ...
    ingredients: ['2 cans tuna or 150g pork', 'Kalabasa, talong, sitaw, okra', 'Bagoong', 'Garlic, onion, tomato'],
    method: 'Sauté garlic, onion, tomato with bagoong. Add kalabasa first, then the rest, cover and steam in its own liquid 12 min. Fold in the tuna at the end.',
  },
  ...
  // ---------------- Hapunan ----------------
  {
    ...
    cookware: 'stovetop',
    tags: ['omega 3', 'simple'],
    ingredients: ['1 boneless bangus belly', 'Salt and pepper', 'Kalamansi', 'Tomato and onion salsa (ensalada)'],
    method: 'Dry the fish well, salt it, cook skin down in a hot dry non-stick pan 6 min, flip 3 min. Serve with the raw tomato-onion salsa and kalamansi.',
  },
  {
    id: 'sinigang-hipon',
    ...
    ingredients: ['300g shrimp', '1 sachet sinigang mix', 'Kangkong, sitaw, labanos, talong', 'Tomato and onion', 'Siling haba'],
  ...
  },
  {
    ...
    ingredients: ['400g chicken thigh or breast', 'Kalamansi, vinegar, lemongrass', 'Ginger, garlic', 'Annatto oil, salt'],
    method: 'Marinate 30 min in kalamansi, vinegar, crushed lemongrass, ginger and garlic. Sear in a covered pan 8 min a side, basting with annatto oil.',
    prepAhead: 'Marinate Sunday, cook fresh in 15 min on the night.',
  },
  {
    id: 'ginataang-tilapia',
    name: 'Ginataang Tilapia with Malunggay',
    category: 'dinner',
    protein: 34,
    calories: 420,
    minutes: 25,
    cookware: 'stovetop',
    tags: ['creamy', 'budget'],
    ingredients: ['2 tilapia fillets', '1 can coconut milk', 'Ginger, garlic, onion', 'Malunggay leaves', 'Siling haba'],
  ...
  },
  {
    ...
    ingredients: ['400g pork kasim, trimmed', '1 sachet sinigang mix', 'Gabi, labanos, sitaw, kangkong', 'Tomato, onion', 'Siling haba'],
    method: 'Boil the pork 30 min until tender, skim the foam. Add tomato, onion and the mix, then vegetables hardest-first. Kangkong last.',
  ...
  },
  {
    ...
    ingredients: ['250g chicken breast, sliced', 'Cabbage, carrot, sayote, baguio beans', 'Garlic, onion', 'Oyster sauce', 'Cornstarch slurry'],
  ...
  {
    id: 'tortang-giniling-monggo',
    name: 'Tofu & Vegetable Torta',
    category: 'dinner',
    protein: 26,
    calories: 360,
    minutes: 18,
    cookware: 'stovetop',
    tags: ['meatless', 'budget'],
    ingredients: ['1 block tokwa, crumbled', '3 eggs', 'Carrot, spring onion', 'Garlic and onion', 'Soy sauce'],
    method: 'Sauté the crumbled tokwa with aromatics and soy, cool slightly, fold into beaten eggs with the vegetables. Fry as small pancakes.',
  },

  // ---------------- Meryenda ----------------
  {
    id: 'boiled-eggs-meryenda',
  ...
  },
  {
    ...
    cookware: 'no-cook',
    tags: ['no cook', 'office'],
    ingredients: ['1 can Century Tuna flakes in oil', '4 Skyflakes crackers', 'Kalamansi, pepper'],
    method: 'Drain the tuna, squeeze kalamansi in, spoon onto crackers.',
  },
  {
    id: 'greek-yog-banana',
  ...
  },
  {
    ...
    minutes: 1,
    cookware: 'no-cook',
    tags: ['classic', 'plant protein'],
    ingredients: ['1 cup silken tofu', 'Arnibal syrup', 'Sago pearls'],
    method: 'Buy it from the taho vendor. Go light on the arnibal, the tofu is the part doing the work.',
  },
  {
    id: 'peanuts-kamote',
    name: 'Boiled Kamote & Peanuts',
    category: 'snack',
    protein: 10,
    calories: 280,
    minutes: 20,
    ...
    ingredients: ['1 medium kamote', 'A handful of boiled peanuts'],
    method: 'Boil the kamote 15 min. Good slow carbs an hour before training.',
  },
  {
    id: 'sikwate-milk-egg',
...
export const GROCERY_LIST: GrocerySection[] = [
  {
    ...
    items: [
      ...
      { name: 'Pork kasim', qty: '½ kg', price: 160, note: 'Sinigang. Trim the visible fat.' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Tokwa (firm tofu)', qty: '3 blocks', price: 90 },
    ],
  },
  {
    id: 'produce',
    ...
    items: [
      { name: 'Kangkong', qty: '2 bundles', price: 40 },
      { name: 'Malunggay or pechay', qty: '2 bundles', price: 45 },
      { name: 'Sitaw, okra, talong, kalabasa', qty: 'mixed, for pinakbet', price: 130 },
      { name: 'Carrot, sayote, cabbage', qty: 'for chopsuey', price: 120 },
      { name: 'Onion', qty: '½ kg', price: 80 },
      { name: 'Garlic', qty: '¼ kg', price: 50 },
      { name: 'Tomato', qty: '½ kg', price: 60 },
      { name: 'Ginger', qty: 'small pack', price: 20 },
      { name: 'Kalamansi', qty: '¼ kg', price: 30 },
      { name: 'Saba banana', qty: '1 kg', price: 70, note: 'Pre-workout carbs and yogurt topping.' },
      { name: 'Kamote', qty: '½ kg', price: 45 },
    ],
  },
  {
    id: 'pantry',
    ...
    items: [
      ...
      { name: 'Monggo beans', qty: '½ kg', price: 60, note: 'Cheapest protein in the store.' },
      ...
      { name: 'Sinigang mix', qty: '3 sachets', price: 45 },
...
export const SUNDAY_PREP: PrepStep[] = [
  ...
  },
  {
    ...
    detail: 'Ten minutes, then straight into cold water. This is your meryenda sorted for the whole week.',
    minutes: 12,
  },
  {
    order: 3,
  ...
  },
  {
    ...
    detail: 'Chicken in kalamansi, vinegar, lemongrass, ginger and garlic. Fridge it. Cooks in 15 minutes midweek.',
    minutes: 10,
  },
  {
    order: 6,
    title: 'Wash and cut the gulay',
    detail: 'Kangkong, sitaw, carrot, sayote into containers. The reason weeknight cooking collapses is the chopping, not the cooking.',
    minutes: 20,
  },
  {
    order: 7,
